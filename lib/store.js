 ...
 */
const { initAuthCreds, BufferJSON, proto } = (await import('@whiskeysockets/bailey')).default

/**
 * @param {import('@whiskeysockets/bailey').WASocket | import('@whiskeysockets/bailey').WALegacySocket}
 */
function bind(conn) {
    if (!conn.chats) conn.chats = {}
    /**
     * 
     * @param {import('@whiskeysockets/bailey').Contact[]|{contacts:import('@whiskeysockets/bailey').Contact[]}} contacts 
     * @returns 
     */
