...
async function sticker5(img, url, packname, wm, categories = [''], extra = {}) {
...
async function addExif(webpSticker, packname, wm, categories = [''], extra = {}) {
  ...
  const json = { 'sticker-pack-id': stickerPackId, 'sticker-pack-name': packname, 'sticker-pack-publisher': wm, 'emojis': categories, ...extra };
