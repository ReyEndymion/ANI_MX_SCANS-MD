...
//console.log('libSticker-sticker: ', type)
...
//
//console.log(`libSticker -> ${func.name}:`, stiker.toString('hex', 0, 4) === '52494646', stiker.toString('ascii', 0, 4), );
...
bufs.push(chunk)})
//console.log('libSticker-sticker1-ffmpeg+convert: ', bufs, ext, mime)
...
let sc = img
console.log('libSticker-sticker2-canvasBySharp: ', mime, sc)
...
console.log('libSticker-sticker5-ffmpeg: ', sticker.filename)
...
console.log('libSticker-sticker4-wa-sticker-formatter: ', sticker, stickerMetadata)
return sticker
}
/**
* Image/Video to Sticker
...
//url = 
console.log('libSticker-sticker5: ', file)
return await res.buffer()
}
const {DEFAULT_HEADERS} = await import('./constants.js')
const { default: fetch } = await import('node-fetch');
const form = new FormData()
form.append('file', new Blob([img]))
let res = await fetch('https://0x0.st', {
method: 'POST',
body: form,
})
/*
...
img.exif = exif
//console.log('addExif: ', img, webpSticker)
