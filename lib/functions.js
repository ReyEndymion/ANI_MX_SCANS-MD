...
if (!fs.existsSync(fileCredsResp)) return
...
console.log(`functionsCheck: `, !global.aniJdbts, fs.readdirSync(jadibts).length === 0);
if (!global.aniJdbts || fs.readdirSync(jadibts).length === 0) {
process.send('reset')
}
}
