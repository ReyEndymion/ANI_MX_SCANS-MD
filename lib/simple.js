...
} = (await import('@whiskeysockets/bailey')).default

export function makeWASocket(connectionOptions, options = {}) {
    /**
     * @type {import('@whiskeysockets/bailey').WASocket | import('@whiskeysockets/bailey').WALegacySocket}
     */
    ...
    let sock = Object.defineProperties(conn, {
        ...
        sendFile: {
             ...
             * @param {import('@whiskeysockets/bailey').proto.WebMessageInfo} quoted
             * @param {Boolean} ptt
            ...
            async value(jid, path, filename = '', caption = '', quoted, ptt = false, options = {}) {
                ...
                /**
                 * @type {import('@whiskeysockets/bailey').proto.WebMessageInfo}
                 */
                let m
                try {
...
END:VCARD
        ...
        cMod: {
             ...
             * cMod
             * @param {String} jid 
             * @param {import('@whiskeysockets/bailey').proto.WebMessageInfo} message 
             * @param {String} text 
             * @param {String} sender 
             * @param {*} options 
             * @returns 
        ...
        loadMessage: {
             ...
             * @returns {import('@whiskeysockets/bailey').proto.WebMessageInfo}
             */
            value(messageID) {
        ...
        processMessageStubType: {
             ...
             * @param {import('@whiskeysockets/bailey').proto.WebMessageInfo} m 
             */
            async value(m) {
                ...
                for (const message of m) {
                    try {
                        ...
                        if (message.message?.[mtype]?.contextInfo?.quotedMessage) {
                            /**
                             * @type {import('@whiskeysockets/bailey').proto.IContextInfo}
                             */
                            let context = message.message[mtype].contextInfo
                            let participant = conn.decodeJid(context.participant)
                            const remoteJid = conn.decodeJid(context.remoteJid || participant)
                            /**
                             * @type {import('@whiskeysockets/bailey').proto.IMessage}
                             * 
                             */
