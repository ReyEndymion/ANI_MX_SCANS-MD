...
await conn.sendMessage(jid, { image: image, caption: txt.trim(), mentions: conn.parseMention(txt) }, {quoted: quoted, ephemeralExpiration: 24*60*100, disappearingMessagesInChat: 24*60*100} );
},
enumerable: true
},
sendAudioRecording: {
