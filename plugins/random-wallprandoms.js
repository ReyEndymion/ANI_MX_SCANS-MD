...
let fgif = { key: {participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "6289643739077-1613049930@g.us" } : {})},message: {"videoMessage": { "title":`️u`, "h": `Hmm`,'seconds': '99999', 'gifPlayback': 'true', 'caption': `🧿 T𝚑e M𝚢stic - Bot 🔮`, 'jpegThumbnail': false }}}
let apikey = keysxxx
...
conn.sendButton(m.chat, `_${command}_`.trim(), `*◈•@${who.split("@s.whatsapp.net")[0]}*`, haha.data, [['🔄 SIGUIENTE 🔄', `/${command}`]], fgif, { mentions: [who] })}
if (command == 'pubg') {
