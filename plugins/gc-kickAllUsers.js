...
let handler = async (m, {conn, args, participants, db, userdb, senderJid}) => {
if (!db.data.bot[conn.user.jid].settings.restrict) {
...
let chat = db.data.bot[conn.user.jid].chats[m.chat]
chat.welcome = false
