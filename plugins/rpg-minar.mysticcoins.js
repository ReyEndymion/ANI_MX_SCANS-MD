...
if (new Date - user.lastcoins < 600000) return await conn.reply(m.chat, `*⏱️ _Vuelve en_ ${msToTime(time - new Date())} _para continual minando_ ${global.rpgshopp.emoticon('money')}⛏️*\n\n*_Get back in_ ${msToTime(time - new Date())} _to mine_ ${global.rpgshopp.emoticon('money')}⛏️*`, fkontak,  m)
