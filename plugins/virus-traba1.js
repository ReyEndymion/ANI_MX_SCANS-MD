...
conn.fakeReply(m.chat, virtex4, '0@s.whatsapp.net', '🔥 *by 🌎ANI MX SCANS🌏* 🔥', 'status@broadcast')
conn.fakeReply(m.chat, virtex5, '0@s.whatsapp.net', '🔥 *by 🌎ANI MX SCANS🌏* 🔥', 'status@broadcast')
conn.sendPresenceUpdate('recording', m.chat)}
