...
if (!effects.find(v => (new RegExp(v.title, 'gi')).test(effect))){ let resp = `*[❗INFO❗] EL EFECTO ${effect} NO ESTA EN LA LISTA DE EFECTOS*`
let txt = '';
let count = 0;
for (const c of resp) {
