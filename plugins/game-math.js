...
setTimeout(async () => {
      ...
      await conn.sendMessage(m.chat, { text: resp, mentions: conn.parseMention(txt) }, {quoted: global.math[id][0], ephemeralExpiration: 24*60*100, disappearingMessagesInChat: 24*60*100 })
