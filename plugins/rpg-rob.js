...
if (new Date - global.db.data.users[m.sender].lastwork < 600000) throw `*_Estas cansado, debes descansar como minimo_ ${msToTime(time - new Date())} 𝚙𝚊𝚛𝚊 𝚟𝚘𝚕𝚟𝚎𝚛 𝚊 hacer un crimen!*`
