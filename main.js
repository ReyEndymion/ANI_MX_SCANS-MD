...
function cleanupOnConnectionError() {
  ...
  // Borrar archivos en la carpeta de sesión
...
function clearTmp() {
  ...
  function purgeSession() {
      ...
      let filesFolderPreKeys = directorio.filter((file) => {
          ...
          const stats = fs.statSync(path.join(`./ANIMXSCANS/${file}`));
